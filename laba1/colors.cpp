...
void Colors::on_comboBox_center_currentTextChanged(QString text)
{
    ...
    if(text == "LAB")
    {
        ...
        ui->label_7->setText("B:");
        ui->label_8->setText("");
        ui->spinBox_5->setRange(-127,128);
        ui->spinBox_6->setRange(-127,128);
        ui->spinBox_7->setRange(-127,128);
    }
    if(text == "HSL")
    {
        ui->label_5->setText("H:");
...
void Colors::on_comboBox_3_currentTextChanged(QString text)
{
    ...
    if(text  == "LAB")
    {
        ...
        ui->label_11->setText("B:");
        ui->label_12->setText("");
        ui->spinBox_9->setRange(-127,128);
        ui->spinBox_10->setRange(-127,128);
        ui->spinBox_11->setRange(-127,128);
